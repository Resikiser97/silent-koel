...
LANG['en'] = {
    ui: {
        ...
        achievementDaysPlayed: 'Days Played',
        achievementProgress: 'Progress',
        achievementNoTitle: 'No titles unlocked yet',
        achievementTitleFrom: 'From: ',
        achievementTitleActive: 'Title',
        achievementLoginRequired: 'Please log in to activate a title',
        achievementGoLogin: 'Go to Login',
        // ── Achievement C group format
        achievementHidden: '???',
        achievementDetailTitle: 'Title: ',
        achievementBonusLabel: 'Reward',
        achievementBonusNone: 'No stat reward',
        achievementBonusSource: 'Achievement',
        achievementBonusOrganSlot: 'Organ Slot',
        achievementBonusSpecialCd: 'Special Skill CD',
        achievementBonusMutationDiscount: 'Mutation exchange cost',
        achievementBonusAllStats: 'All Stats',
        achievementBonusForceEvoChoice: 'Force evolution choice at max evolution stars',
        // ── Stat panel title / units
        statPanelTitle: 'Current Stats',
        unitPerFruit: '/fruit',
        unitPerKill: '/kill',
        unitPerCorpse: '/carnivore1',
        achievementPageFmt: '{cur} / {total}',
        achievementCountFmt: '({unlocked} / {total})',
        achievementProgressFmt: 'Progress: {unlocked} / {total}',
        achievementDaysFmt: 'Days Played: {n}',
        // ── Stat panel B group stat keys
        statAtk: 'Atk',
        statAttackSpeed: 'Atk Speed',
        statAttackInterval: 'Interval',
        statHp: 'Max HP',
        statSpeed: 'Speed',
        statSize: 'Size',
        statRange: 'Atk Range',
