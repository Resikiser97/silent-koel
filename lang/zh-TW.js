...
LANG['zh-TW'] = {
    ui: {
        ...
        achievementBtn:   '成就',
        achievementTitle: '🏆 成就',
        achievementUnlocked: '解鎖日期',
        achievementHowTo: '如何獲得',
        achievementDaysPlayed: '遊玩天數',
        achievementProgress: '成就進度',
        achievementNoTitle: '尚未解鎖任何稱號',
        achievementTitleFrom: '來自：',
        achievementTitleActive: '稱號',
        achievementLoginRequired: '稱號需要登入後才能啟用',
        achievementGoLogin: '前往登入',
        // ── 成就 C 組格式
        achievementHidden: '???',
        achievementDetailTitle: '稱號：',
        // ── 屬性面板標題 / 單位
        statPanelTitle: '當前屬性',
        unitPerFruit: '/果',
        unitPerKill: '/殺',
        achievementPageFmt: '{cur} / {total}',
        achievementCountFmt: '({unlocked} / {total})',
        achievementProgressFmt: '成就進度：{unlocked} / {total}',
        achievementDaysFmt: '遊玩天數：{n} 天',
        // ── 屬性面板 B 組 stat key
        statAtk: '攻擊',
        statHp: '血量上限',
        statSpeed: '速度',
