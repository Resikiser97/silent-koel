...
LANG['zh-TW'] = {
    ui: {
        ...
        achievementBonusLabel: '獎勵',
        achievementBonusNone: '無數值獎勵',
        achievementBonusSource: '成就',
        achievementBonusOrganSlot: '器官槽',
        achievementBonusSpecialCd: '特殊技能 CD',
        achievementBonusMutationDiscount: '變異交換費用',
        achievementBonusAllStats: '全屬性',
        achievementBonusForceEvoChoice: '進化滿星時可強制選擇進化',
        // ── 屬性面板標題 / 單位
        statPanelTitle: '當前屬性',
        unitPerFruit: '/果',
        unitPerKill: '/殺',
